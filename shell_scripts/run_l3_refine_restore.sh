...
echo
echo "============================================================"
echo "L3 REFINE: always_restore, concurrency=1"
...
RESET_RESULT=1 \
RESULT_FILE="$RESULT_DIR/l3_restore_c1_refine.jsonl" \
python shell_scripts/bench_hicache_agent.py

echo
echo "============================================================"
echo "L3 REFINE: always_restore, concurrency=16"
...
L3_BACKUP_TIMEOUT_S=180 \
RESET_RESULT=1 \
RESULT_FILE="$RESULT_DIR/l3_restore_c16_refine.jsonl" \
python shell_scripts/bench_hicache_agent.py

echo
echo "============================================================"
echo "L3 REFINE: always_restore, concurrency=32"
...
L3_BACKUP_TIMEOUT_S=180 \
RESET_RESULT=1 \
RESULT_FILE="$RESULT_DIR/l3_restore_c32_refine.jsonl" \
python shell_scripts/bench_hicache_agent.py

echo
echo "============================================================"
echo "ALL L3 RESTORE REFINE CASES FINISHED"
echo "============================================================"
